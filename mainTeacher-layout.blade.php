...
<div class="sidebar">
    <h2>KAFAMS TEACHER</h2>
    <a href="{{ route('home.teacher') }}" class="{{ Request::routeIs('home.student') ? 'active' : '' }}">Home</a>
...
<a href="{{ route('bulletin.indexBulletinTeacher') }}"
   class="{{ Request::routeIs('bulletin.indexBulletinTeacher') ? 'active' : '' }}">
   KAFA Bulletin
</a>
</div>
