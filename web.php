...
Route::get('/home/kafa', [HomeController::class, 'kafa'])->name('home.admin');
Route::get('/home/muip', [HomeController::class, 'muip'])->name('home.muip');
Route::get('/home/parent', [HomeController::class, 'parent'])->name('home.parent');
Route::get('/home/teacher', [HomeController::class, 'teacher'])->name('home.teacher');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/bulletin/teacher', [BulletinController::class, 'indexTeacher'])
        ->name('bulletin.indexBulletinTeacher');
});


Route::get('/bulletin', [BulletinController::class, 'index'])->name('bulletin.indexBulletin');
Route::get('/bulletin/admin/create', [BulletinController::class, 'create'])
    ->name('bulletin.createBulletin');

Route::get('/bulletin/muip/create', [BulletinController::class, 'createMUIP'])->name('bulletin.createBulletinMUIP');
...
Route::middleware(['auth'])->group(function () {
    Route::get('/bulletin/muip', [BulletinController::class, 'indexMUIPAdmin'])
        ->name('bulletin.indexMUIPAdmin');
Route::get('/bulletin/muip/edit/{id}', [BulletinController::class, 'editMUIP'])
    ->name('bulletin.editMUIP');


   Route::post('/bulletin/approve/{id}', [BulletinController::class, 'approve'])
    ->withoutMiddleware('verifyCsrfToken')
    ->name('bulletin.approve');

    Route::post('/bulletin/reject/{id}', [BulletinController::class, 'reject'])
    ->name('bulletin.reject');


});

Route::get('/bulletin/admin', function() {
    $user = User::where('type', 'kafa_admin')->first();
    auth()->login($user);
    return app(\App\Http\Controllers\BulletinController::class)->indexAdmin(request());
})->name('bulletin.indexBulletinAdmin');
